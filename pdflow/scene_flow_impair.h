...
/**
 * Changes:
 * 1. We can choose how many images are saved when saving results.
 */
...
public:
    ...
    float fovv;     //vertical field of view in radians
    ...
    void saveResults( const cv::Mat& image, const unsigned int& image_count );
	void showAndSaveResults( const unsigned int& image_count );
